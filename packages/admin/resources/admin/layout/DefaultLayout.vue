...
const menuGroups = computed<NavGroup[]>(() => [
  ...
  },
  {
    ...
    routeName: 'adminExperiencePage',
  },
  {
    group: 'Travel Months',
    icon: 'mdi-calendar-range',
    routeName: 'adminTravelMonthPage',
  },
  {
    group: 'Articles',
  ...
  {
    group: 'Traveler Stories',
    icon: 'mdi-book-open-page-variant-outline',
    routeName: 'adminTravelerStoryPage',
  },
  {
    group: 'Inquiries',
  ...
  {
    group: 'Planner Submissions',
    icon: 'mdi-calendar-check-outline',
    routeName: 'adminPlannerSubmissionPage',
  },
  {
    group: 'Newsletter Subscribers',
    icon: 'mdi-email-newsletter',
    routeName: 'adminNewsletterSubscriptionPage',
  },
  {
    group: 'Website',
    icon: 'mdi-cog-outline',
    items: [
      { title: 'Pages', routeName: 'adminWebsitePage', icon: 'mdi-file-document-outline' },
      { title: 'Sections', routeName: 'adminWebsiteSectionPage', icon: 'mdi-view-dashboard-outline' },
      { title: 'Media', routeName: 'adminMediaAssetPage', icon: 'mdi-image' },
      { title: 'Notifications', routeName: 'adminNotificationPage', icon: 'mdi-bell-outline' },
      { title: 'Website Settings', routeName: 'adminGeneralSettingPage', icon: 'mdi-cog-outline' },
    ],
  },
  {
    group: 'FAQs',
