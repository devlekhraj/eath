<template>
	...
	<v-card-actions class="justify-space-around">
		<v-btn color="primary" :loading="uploading" :disabled="!uploadFile || uploading || Boolean(sizeError)" @click="handleUpload">
			Upload & Select
		</v-btn>
	</v-card-actions>
</template>
...
async function handleUpload() {
	...
	try {
		...
		const resp = await http.post(`/admin/destinations/${destinationId}/save-image`, formData)
