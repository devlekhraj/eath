<template>
  <v-card>
      ...
      <div class="px-6 py-4">
        <v-row>
          ...
          <v-col cols="12" md="8">
            <div class="mb-2">
              <v-text-field
                :model-value="draftMeta.alt_text"
                label="Alt Text"
                :disabled="!imageItem"
            ...
            <div class="mb-2">
              <v-textarea
                :model-value="draftMeta.description"
                label="Description"
                rows="4"
                auto-grow
                :disabled="!imageItem"
    ...
    <v-card-actions class="justify-end">
      <v-btn color="primary" :loading="submitting" :disabled="submitting || !imageItem" @click="handleUpdate()">Update</v-btn>
    </v-card-actions>
  </v-card>
</template>
