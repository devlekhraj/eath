						...
						<v-card class="pa-6">
							...
							<v-card-text class="pt-10">
								<v-row>
									...
									<v-col cols="12">
										<div>
											<v-text-field v-model="form.slug" label="URL" :rules="[rules.required]" :error-messages="errors.slug" :disabled="submitting || form.published_at" required />
										</div>
									...
									<v-col cols="6">
										<v-text-field v-model="form.altitude" label="Altitude (feet)" type="number" prepend-inner-icon="mdi-image-filter-hdr" :rules="[rules.numeric, rules.positive]" :error-messages="errors.altitude" :disabled="submitting" />
									</v-col>
									...
									<v-col cols="12">
										<v-select v-model="form.category_ids" :items="package_categories" item-title="name" item-value="id" label="Select Categories" multiple chips clearable />
									</v-col>
									<v-col cols="6">
