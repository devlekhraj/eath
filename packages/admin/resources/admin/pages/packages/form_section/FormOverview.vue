    ...
    <div class="mb-4">
        <v-card class="pa-2">
            <v-card-text class="pt-10">
                <v-row>
                    <v-col cols="12">
                        <v-textarea v-model="form.name" label="Package Name" :rules="[rules.required]" rows="2" auto-grow :error-messages="errors.name" :disabled="submitting" required />
                    </v-col>
                    ...
                    <v-col cols="12" md="6" lg="8">
                        <v-select v-model="form.destination_id" :items="destination_list" item-title="name" item-value="id" label="Select Destination" clearable />
                    </v-col>
