...
<div class="website-container" style="padding-top: var(--space-6); padding-bottom: var(--space-12);">
    ...
    <section aria-labelledby="heading-choose-cta" class="website-final-cta" style="border-radius: 0 !important;">
        <div class="website-final-cta__inner">
            ...
            <h2 id="heading-choose-cta" class="website-final-cta__title" style="font-size: var(--type-h2);">
            ...
            <div class="website-final-cta__actions">
                <a href="{{ route('website.planner.start') }}?mode=discover&source=experience"
