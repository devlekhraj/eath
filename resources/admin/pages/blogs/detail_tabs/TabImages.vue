        ...
        <div v-if="galleryItems.length">
            <v-data-table :headers="tableHeaders" :items="galleryItems" item-key="id">
                <template #item.image="{ item }">
                    <div class="py-4">
                        <v-img :src="item?.url || item?.image_url || item" height="60" width="100" contain class="rounded" />
                    </div>
                </template>
                ...
                <template #item.actions="{ item }">
                    <div style="min-width: 100px;">
                        ...
                        <v-btn size="x-small" icon variant="tonal" color="error" class="ml-2" @click="handleDelete(item)">
