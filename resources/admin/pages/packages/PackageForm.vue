      ...
      <v-row>
          ...
          <v-card elevation="0" class="pa-6">
            <div class="mb-4">
              <v-text-field v-model="form.name" label="Package Name" :rules="[rules.required]"
                :error-messages="errors.name" density="comfortable" variant="outlined" :disabled="submitting"
                required />
            </div>

            <div class="mb-4">
              <v-text-field v-model="form.slug" label="URL" :rules="[rules.required]" :error-messages="errors.slug"
                density="comfortable" variant="outlined" :disabled="submitting" required />
            </div>
            ...
            <v-textarea v-model="form.additional_info" label="Additional Info" rows="3" variant="outlined" auto-grow
              class="mt-4" :error-messages="errors.additional_info" />
        ...
        <v-col cols="12" md="4">
          <v-card elevation="0" class="pa-6">
            <v-row class="mt-2">
              <v-col cols="6">
                <v-text-field v-model="form.duration_days" label="Duration (Days)" density="comfortable" type="number"
                  variant="outlined" prepend-inner-icon="mdi-clock"
                  :rules="[rules.required, rules.numeric, rules.positive]" :error-messages="errors.duration_days"
                  :disabled="submitting" />
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="form.duration_nights" label="Duration (Nights)" density="comfortable"
                  type="number" variant="outlined" prepend-inner-icon="mdi-clock"
                  :rules="[rules.required, rules.numeric, rules.positive]" :error-messages="errors.duration_nights"
                  :disabled="submitting" />
              </v-col>
              ...
              <v-col cols="6">
                <v-text-field v-model="form.altitude" label="Altitude (feet)" type="number" density="comfortable"
              ...
              <v-col cols="6">
                <v-date-input v-model="form.end_date" label="End Date" prepend-icon="" prepend-inner-icon="mdi-calendar"
                  variant="outlined" density="comfortable" :error-messages="errors.end_date" :disabled="submitting" />
              </v-col>
              ...
              <v-col cols="12">
                <v-textarea v-model="form.terms_conditions" label="Terms & Conditions" rows="3" variant="outlined"
                  auto-grow class="mt-4" :error-messages="errors.terms_conditions" />
              </v-col>

              <v-col cols="12">
                <v-textarea v-model="form.cancellation_policy" label="Cancellation Policy" rows="3" variant="outlined"
                  auto-grow class="mt-2" :error-messages="errors.cancellation_policy" />
              </v-col>
            </v-row>
          </v-card>
        </v-col>
