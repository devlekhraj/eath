<template>
    <v-card flat>
        ...
        <v-card-actions class="justify-space-between">
            ...
            <div>
                <v-btn variant="text" color="error" :loading="loading_delete" :disabled="loading_delete" @click="handleDelete">Delete</v-btn>
                <v-btn color="primary" class="ml-4" :loading="loading" :disabled="loading"
