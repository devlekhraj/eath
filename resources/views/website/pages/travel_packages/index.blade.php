                ...
                <div class="col-md-12 col-lg-10 offset-lg-1">
                    ...
                    <div class="px-5">
                        ...
                        @if ($package->prices->count() > 0)
                            <div class="mb-4">
                                {{-- <h5 class="fw-semibold mb-3">Pricing List</h5> --}}

                                <div class="table-responsive">
                                    <table class="table text-center align-middle"
                                        style="border-collapse: separate; border-spacing: 0 1rem;">
                                        <thead>
                                            <tr class="bg-primary text-white" style="border-radius: 0.5rem;">
                                                <th scope="col" class="py-3 px-4"
                                                    style="border: 1px solid #0d6efd; border-radius: 0.5rem 0 0 0.5rem; font-weight: 600; font-size: 1.1rem;">
                                                    Price Type
                                                </th>
                                                <th scope="col" class="py-3 px-4"
                                                    style="border: 1px solid #0d6efd; border-radius: 0 0.5rem 0.5rem 0; font-weight: 600; font-size: 1.1rem;">
                                                    Price (USD)
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($package->prices as $price)
                                                <tr
                                                    style="border: 1px solid #dee2e6; border-radius: 0.5rem; box-shadow: 0 2px 6px rgb(13 110 253 / 0.1); background-color: #ffffff;">
                                                    <td class="py-3 px-4 fw-semibold"
                                                        style="border-right: 1px solid #dee2e6;">
                                                        <span class="text-capitalize"> {{ $price->title }}</span>
                                                    </td>
                                ...
                                <!-- 📌 Note Section -->
                                <div class="mt-4 p-3 bg-light border-start border-4 border-info rounded shadow-sm">
                                    <h6 class="fw-semibold text-info mb-3" style="letter-spacing: 0.05em;">
                                        <i class="fas fa-info-circle me-2"></i>
                                        Note for Economy Package:
                                    </h6>
                                    <ul class="list-unstyled ps-3 mb-0">
                                        <li class="mb-2 d-flex align-items-center">
                                            <i class="fas fa-info-circle text-info me-3 fs-5"></i>
                                            <span class="" style="font-size: 0.95rem;">
                                                Budget hotel accommodation (non-star rated)
                                            </span>
                                        </li>
                                        <li class="mb-2 d-flex align-items-center">
                                            <i class="fas fa-info-circle text-info me-3 fs-5"></i>
                        ...
                        @if ($package->inclusions->count() > 0)
                            <div class="mb-5 p-4 bg-white rounded shadow-sm border border-success">
                                ...
                                <ul class="list-unstyled ps-3 mb-0">
                                    ...
                                    {{-- <li class="d-flex align-items-center mb-3">
                                        <i class="fas fa-check-circle text-success me-3 fs-5"></i>
                                        <span class="fw-semibold text-dark">Accommodation in 3-star hotels</span>
                                    </li>
                                    <li class="d-flex align-items-center">
                                        <i class="fas fa-check-circle text-success me-3 fs-5"></i>
                                        <span class="fw-semibold text-dark">Daily breakfast included</span>
                                    </li> --}}
                                </ul>
                            </div>
                        @endif
                        ...
                        @if ($package->exclusions->count() > 0)
                            <div class="mb-4 p-4 bg-white rounded shadow-sm border border-danger">
                                ...
                                <ul class="list-unstyled ps-3 mb-0">
                                    ...
                                    {{-- <li class="d-flex align-items-center mb-3">
                                    <i class="fas fa-times-circle text-danger me-3 fs-5"></i>
                                    <span class="fw-semibold text-dark">Personal travel insurance</span>
                                </li>
                                <li class="d-flex align-items-center">
                                    <i class="fas fa-times-circle text-danger me-3 fs-5"></i>
                                    <span class="fw-semibold text-dark">Tips and personal expenses</span>
                                </li> --}}
                                </ul>
                            </div>
                        @endif
