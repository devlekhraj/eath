        ...
        <div class="grid gap-0 lg:grid-cols-[2fr_1fr] flex-1 overflow-y-auto">
            <div class="space-y-5 px-6 py-6" data-fd-form-wrap>
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit" data-fd-submit-btn
                        class="inline-flex items-center gap-2 rounded-md bg-slate-900 px-4 py-2 text-xs font-semibold text-white hover:bg-slate-800 disabled:opacity-70 disabled:cursor-not-allowed">
                        <span data-fd-submit-text>Confirm & Submit</span>
                        <svg data-fd-submit-spinner class="hidden h-3 w-3 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
